...
async def doc(bot, update):
    ...
    await ms.edit(" 𝘗𝘳𝘦𝘱𝘢𝘳𝘪𝘯𝘨 𝘵𝘰 𝘳𝘦𝘤𝘦𝘪𝘷𝘦  𝘧𝘪𝘭𝘦...")
    c_time = time.time() 
    try:
       if type == "document":
          await bot.send_document(
           ...
           await bot.send_audio(
	        ...
	        duration=duration,
	        progress=progress_for_pyrogram,
	        progress_args=( "ʀᴇᴄɪᴇᴠɪɴɢ ꜰɪʟᴇ ꜰʀᴏᴍ ʟᴀᴢʏ  ",  ms, c_time   )) 
    except Exception as e: 
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @S_B_G01 ')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton(' Updates ', url='https://t.me/S_B_G01')
        ], [
            InlineKeyboardButton(' Help ', callback_data='help'),
            InlineKeyboardButton(' About ', callback_data='about')
        ],[
            InlineKeyboardButton('join ', url='https://t.me/ccgrouplinks')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton(' Updates ', url='https://t.me/darylupdates'),
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢 𝚜𝚘𝚗𝚊 `{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ **ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ** !\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : `{search}`\n➟ 👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : `{message.from_user.first_name}`",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Add me to your group", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("dev", url="https://t.me/S_B_G01"), InlineKeyboardButton("creator", url="https://t.me/S_B_G01"), InlineKeyboardButton(" Main Ch", url="https://t.me/darylupdates")],[InlineKeyboardButton("from cinema company", callback_data="close_data")]]))
