...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('Series Group ', url='https://t.me/seriescc')
            ],
            [
                InlineKeyboardButton(' Help ', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('Admin', url='https://t.me/S_B_G01')
            ]]
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    " SUBSCRIBE TG Channel ", url='https://t.me/ccgrouplinks'
                )
            ]
        ]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton(' Search ', switch_inline_query_current_chat=''),
            InlineKeyboardButton('Series', url='https://t.me/seriescc')
            ],[
            InlineKeyboardButton(' Help ', callback_data='help'),
            InlineKeyboardButton(' About ', callback_data='about')
        ],[
